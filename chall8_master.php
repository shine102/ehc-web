...
<?php
$conn = mysqli_connect('18.142.121.142', 'master', '', 'ehc-workshop');
...
$filter = array("chall_master","list_challenge","solve", "id", "password");
    ...
    <body>
        <div id="main" class="bg-black h-[100vh] w-[100vw] relative">
            <div class="flex flex-col items-center py-10 h-[100%]">
                ...
                <div class="md:w-[40%] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-black bg-opacity-80 w-[100%] mt-10" style="padding:20px;">
                    <div class="flex flex-col text-white">
                        <span class="text-xl py-5"><?php echo $chall_detail['Chall_name'] ?></span>
                        <span style="font-family: 'Segoe UI', Arial, sans-serif;">
                            <?php echo $chall_detail['Description'] ?>
                        </span>
                        <span class="py-5" style="font-family: 'Segoe UI', Arial, sans-serif;">
                            <?php echo $chall_detail['Hint'] ?>
                        </span>
                    </div>
                ...
                <span id="message" class="text-xl text-white"></span>
                <div class="mt-auto">
...
<?php 
if ($score > 3500) {
    $message = "EHC{Thank_you_for_joining_EHC_Information_Assurance_Day}";
    echo "<script defer type='text/javascript'>document.getElementById('message').innerHTML = 'EHC{Thank_you_for_joining_EHC_Information_Assurance_Day}'</script>";
}
if($score < 3500) {
