...
(1, 'Description', 'Hint'),
(2, 'Description: Hey bro,you were very excellent pass 7 challenges', 'My reaction to that information: Outstanding!'),
(3, 'Description: So, this is a little challenge for you', 'Hint: Somewhere on this website'),
(4, 'Description: I believe you can do it', 'Hint: Injection, users - score'),
(5, 'Description: Show me your skill', 'Hint: Can you change your score up to 7000?');
...
CREATE TABLE `list_challenge` (
  ...
  `Hint` varchar(2500) DEFAULT NULL,
...
(1, 'Linux_1', 'Description: Bắt đầu làm quen với việc kết nối tới 1 server linux và đọc file trên đó nào! <br>  Lưu ý: đáp án của challenge này sẽ là mật khẩu cho challenge sau (ví dụ đáp án của challenge 1 sẽ là mật khẩu cho challenge 2 và tương tự) <br> Đáp án luôn có dạng EHC{...} (phần “…” là chữ hoặc số) <br> Câu lệnh kết nối:  <br> ssh challenge1@13.212.155.34 -p 2220 hoặc kết nối qua PuTTy với hostname: 13.212.155.34, port: 2220, username: challenge1 <br> Mật khẩu: ehcgreat <br> ', 'Hint:Đáp án nằm ở file flag.txt', 'EHC{s5h_f0r_7h3_4cc3sS}'),
(2, 'Linux_2', 'Description: File chứa đáp án của challenge này đã bị ẩn. Bạn có thể tìm ra nó không?  <br> Lưu ý: Đáp án luôn có dạng EHC{...} (phần “…” là chữ hoặc số) <br> Câu lệnh kết nối:  <br> ssh challenge2@13.212.155.34 -p 2221 hoặc kết nối qua PuTTy với hostname: 13.212.155.34, port: 2221, username: challenge2 <br> Mật khẩu: đáp án của challenge trước. <br> ', 'Hint:cat readme.md', 'EHC{s0m3tHiNg_y0u_c4n7_s33}'),
(3, 'Linux_3', 'Desciption: Ôi không! Đáp án của chúng ta đang ở trong file text chứa cả một biển từ thế này! Phải làm thế nào đây? <br> Lưu ý: Đáp án luôn có dạng EHC{...} (phần “…” là chữ hoặc số) <br> Câu lệnh kết nối:  <br> ssh challenge3@13.212.155.34 -p 2222 hoặc kết nối qua PuTTy với hostname: 13.212.155.34, port: 2222, username: challenge3 <br> Mật khẩu: đáp án của challenge trước. <br> ', 'Hint: cat readme.md', 'EHC{W0lf_1n_4_fl0ck_0f_5h33p}'),
(4, 'Linux_4', 'Description: Trong linux, file được phân quyền rất nghiêm ngặt, với 3 nhóm quyền: User (Người tạo ra file), Group (nhóm của người đã tạo ra file), Other (người dùng khác). Các quyền của từng nhóm cũng chia làm 3 loại: quyền đọc (read - r), quyền ghi (write - w), quyền thực thi (execute - x). Có vẻ lần này, với tài khoản login vào hệ thống, chúng ta không có quyền đọc được file đáp án rồi. Hãy thử tìm cách nhé. <br> Lưu ý: Đáp án luôn có dạng EHC{...} (phần “…” là chữ hoặc số) <br> Câu lệnh kết nối:  <br> ssh challenge4@13.212.155.34 -p 2223 hoặc kết nối qua PuTTy với hostname: 13.212.155.34, port: 2223, username: challenge4', 'Hint:cat readme.md', 'EHC{pr1v1l3g3_35c4l4t10n}'),
(5, 'Linux_5', 'Description: Ôi không! Nhiều file thế này! Thật giả lẫn lộn làm sao mà tìm được file flag đây? <br> Lưu ý: Đáp án luôn có dạng EHC{...} (phần “…” là chữ hoặc số) <br> Câu lệnh kết nối:  <br> ssh challenge5@13.212.155.34 -p 2224 hoặc kết nối qua PuTTy với hostname: 13.212.155.34, port: 2224, username: challenge5 <br> Mật khẩu: đáp án của challenge trước. <br> ', 'Hint: cat readme.md', 'EHC{d0_sM4rT3r_n0t_h4rD3r}'),
(6, 'Redteam', 'Description: Vào discord server tại link: https://discord.gg/CbtHNNMH, sử dụng lệnh $red_team tại channel red_bot và chờ đợi inbox từ chú bot thần thánh.', 'Hint: No hint', 'EHC{mak3_IA_gr3at_aga1n_02/12/2017}'),
(7, 'Blueteam', 'Description: Vào discord server tại link: https://discord.gg/CbtHNNMH, sử dụng lệnh /blue_team tại channel blue_bot và chờ đợi inbox từ chú bot thần thánh.', 'Hint:No hint', 'EHC{Nguyen_Doanh_Thinh_Ethical_Hacker_Club}'),
(8, 'Ultimate Challenge', 'Are you a real hackẻ lỏd???', 'No hint, of course', 'Co cai nit ban oi :))');
...
(1, 'team_01', 'd5ca6e51e91b44883d5885df14e7bbd046be019ce4f00d2143a97a22b1cc1280', 0),
(2, 'team_02', 'd66db214228c3e67241fb36cbf0c70a2ed6d2253ed88eb8cea76b7707ff422e9', 0),
(3, 'team_03', '93540b779e37fbec81f95c516cbf5dd6b42291521d52cba19dd404af496d6b1c', 0),
(4, 'team_04', '885f7cd3c6b6d261d74ad9f01b10408cbc21fb5263362bbc717d6490f429325c', 0),
(5, 'team_05', 'a14b6c43fe992c1edb5732e35ba8cf0a6ffb0d1b2aca0ec2daca3a5a5aa518fe', 0),
(6, 'team_06', '7f63ccf795c7565328936011ea152b7ab2b220e9f5386fe5625a94f54de94e8a', 0),
(7, 'team_07', '70c59f2fcb501db0634a3d1b53e9d24ea24eef8c883f1c98ffdd50c39d11a017', 0),
(8, 'team_08', '15adff8a12d532aa2d5d4b1c0dc0953c9f036c49644c2e456d25692d2a10086f', 0),
(9, 'team_09', '916e1b3c0fc2b1490b14496d0fd889ce4fe516886b5ef23bcdfe6bbfc0e4a525', 0),
